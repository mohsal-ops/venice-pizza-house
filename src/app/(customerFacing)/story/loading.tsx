export default function Loading() {
  return (
    <main className="flex flex-col items-center pt-24 space-y-24 animate-pulse">
      ...
      {/* HERO SKELETON */}
      <section className="relative w-full h-[85vh] flex items-center justify-center bg-muted/60">
        <div className="text-center space-y-6 px-6">
          <div className="h-12 md:h-16 w-64 md:w-96 bg-muted rounded-lg mx-auto" />
          <div className="h-5 md:h-6 w-80 md:w-lg bg-muted rounded mx-auto" />
        </div>
      </section>

      {/* INTRO */}
      <section className="max-w-5xl px-6 text-center space-y-6">
        <div className="h-8 w-96 bg-muted rounded mx-auto" />
        <div className="h-5 w-full max-w-3xl bg-muted rounded mx-auto" />
        <div className="h-5 w-full max-w-2xl bg-muted rounded mx-auto" />
      </section>

      {/* IMAGE + TEXT */}
      <section className="grid md:grid-cols-2 gap-12 max-w-6xl px-6 items-center w-full">
        <div className="w-full h-80 bg-muted rounded-3xl" />
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-card rounded-2xl p-8 shadow-sm space-y-4"
              >
