...
export const metadata: Metadata = {
  ...
  description:
    "Terms of service, privacy policy, and ordering policies for Pam's Kitchen in Houston, TX.",
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            By accessing and using Pam's Kitchen restaurant website and services, you agree to be bound by these terms and conditions.
          </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            The information provided on this website is for informational purposes only. Pam's Kitchen makes no representations or warranties of any kind regarding the accuracy or completeness of the content.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700">
            In no event shall Pam's Kitchen be liable for any indirect, incidental, special, or consequential damages arising from your use of this website or services.
          </p>
        </section>
