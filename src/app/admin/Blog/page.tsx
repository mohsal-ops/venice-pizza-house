        ...
        <div className="bg-white border border-[#c85a1e]/20 rounded-2xl p-4 mb-6 flex gap-3 items-start">
          ...
          <div>
            ...
            <p className="text-xs text-stone-500 mt-1 leading-relaxed">
              ...
              Only these manual blog posts do. Aim for <span className="font-semibold text-stone-700">2-3 posts per week</span> about your food, events, recipes, or anything related to Pam's Kitchen.
            </p>
          </div>
        </div>
      </div>
